 ...
 *
 * Expects one command-line argument: the map file path.
 * Initializes SDL, loads the map and wall texture, then enters the
 * main loop to process input and render the scene.
